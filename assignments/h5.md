...
HUOM.
local.cmd.run ei ole virallinen Saltin tila (state) vaan Reactorin erikoisuus. 
Lue tästä lisää: https://docs.saltproject.io/en/latest/topics/reactor/index.html#examples
